...
<View style={styles.inputSubMain}>
    <Text style={styles.InputText}>Length (Shalwar)</Text>
    <TextInput style={styles.inputField}  
    value={data.length2} 
    keyboardType={'number-pad'}
    onChangeText={txt=>setData({...data,length2:txt})}
     />
</View>
</View>
...
<View style={styles.inputSubMain}>
    ...
    value={data.hip2}
    keyboardType={'number-pad'}
    onChangeText={txt=>setData({...data,hip2:txt})}
      />
</View>
<View style={styles.inputSubMain}>
<View style={styles.inputSubMain}>
